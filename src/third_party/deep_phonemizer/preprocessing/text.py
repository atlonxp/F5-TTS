...
class Preprocessor:
    ...
    def from_config(cls, config: Dict[str, Any]) -> 'Preprocessor':
        ...
        text_tokenizer = SequenceTokenizer(symbols=text_symbols,
                                           ...
                                           lowercase=lowercase,
                                           append_start_end=True) #input is phoneme set as phn
        
        # print("text_tokenizer")
        # print(text_tokenizer.token_to_idx)
        
        phoneme_tokenizer = SequenceTokenizer(phoneme_symbols,
                                              languages=lang_symbols,
                                              lowercase=False,
                                              char_repeats=1,
                                              append_start_end=True,ftype="phn")
        
        # print("phoneme_tokenizer")
        # print(phoneme_tokenizer.idx_to_token)
