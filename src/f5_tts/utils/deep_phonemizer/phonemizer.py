...
from f5_tts.utils.deep_phonemizer.model.model import load_checkpoint
from f5_tts.utils.deep_phonemizer.model.predictor import Predictor
from f5_tts.utils.deep_phonemizer.result import PhonemizerResult
from f5_tts.utils.deep_phonemizer.utils.logging import get_logger
...
class Phonemizer:
    ...
    def phonemise_list(self,
        ...
        for text in texts:
            cleaned_text = text  # ''.join([t for t in text if t.isalnum() or t in punc_set])
        ...
        # print('word_phonemes',word_phonemes)
